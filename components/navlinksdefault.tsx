    ...
    <header className="bg-green-900">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-4 items-center">
          <a href="#" className="text-sm/6 font-semibold text-white/98">
            Login
          </a>
          <a href="#" className="text-sm/6 font-semibold text-white/98 border border-black/10 px-3 py-1 rounded-lg bg-green-700 hover:bg-green-800 -my-2.5">
            Sign Up
          </a>
        </PopoverGroup>
      </nav>
