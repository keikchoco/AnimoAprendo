...
export default function SwitchToTutor() {
    ...
    return (
        <li><Link href="/tutor/dashboard" onNavigate={(e) => {
            ...
            updateMetadata()
            e.preventDefault()
        }} className='bg-gradient-to-r from-green-300 via-green-500 to-blue-400 inline-block text-transparent bg-clip-text font-bold text-sm text-center'>Switch To Tutor</Link></li>
    )
}